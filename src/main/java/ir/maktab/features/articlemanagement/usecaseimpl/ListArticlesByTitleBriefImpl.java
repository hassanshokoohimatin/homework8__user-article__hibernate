...
import ir.maktab.features.articlemanagement.usecase.ListArticlesByTitleBrief;
...
public class ListArticlesByTitleBriefImpl implements ListArticlesByTitleBrief {
    @Override
